...
function getSampleData(string $table): ?array {
    $samples = [
        'students' => [
            ['name' => 'Juan Dela Cruz', 'studentId' => 'BCP-2024-0001', 'course' => 'ICT', 'yearLevel' => 'Grade 12', 'bloodType' => 'O+', 'allergies' => 'None', 'conditions' => 'Asthma', 'contactNumber' => '09171234567', 'emergencyContact' => 'Maria Dela Cruz - 09179876543'],
            ['name' => 'Maria Santos', 'studentId' => 'BCP-2024-0002', 'course' => 'HUMSS', 'yearLevel' => 'Grade 11', 'bloodType' => 'A+', 'allergies' => 'Penicillin', 'conditions' => 'None', 'contactNumber' => '09187654321', 'emergencyContact' => 'Pedro Santos - 09171112233'],
        ],
        'medicalRecords' => [
            ['recordId' => 'MR-2026-01', 'status' => 'Active', 'studentId' => 'BCP-2024-0001', 'studentName' => 'Juan Dela Cruz', 'department' => 'ICT', 'yearLevel' => 'Grade 12', 'section' => 'A', 'bloodType' => 'O+', 'allergies' => 'None', 'medicalConditions' => 'Asthma', 'height' => '170', 'weight' => '65', 'vision' => '20/20', 'hearing' => 'Normal', 'immunizationStatus' => 'Complete', 'remarks' => 'Regular checkup required'],
            ['recordId' => 'MR-2026-02', 'status' => 'Active', 'studentId' => 'BCP-2024-0002', 'studentName' => 'Maria Santos', 'department' => 'HUMSS', 'yearLevel' => 'Grade 11', 'section' => 'B', 'bloodType' => 'A+', 'allergies' => 'Penicillin', 'medicalConditions' => 'None', 'height' => '165', 'weight' => '58', 'vision' => '20/25', 'hearing' => 'Normal', 'immunizationStatus' => 'Incomplete', 'remarks' => 'Needs tetanus booster'],
            ['recordId' => 'MR-2026-03', 'status' => 'Active', 'studentId' => 'BCP-2024-0003', 'studentName' => 'Carlos Garcia', 'department' => 'STEM', 'yearLevel' => 'Grade 12', 'section' => 'A', 'bloodType' => 'B+', 'allergies' => 'Dust mites', 'medicalConditions' => 'None', 'height' => '175', 'weight' => '70', 'vision' => '20/20', 'hearing' => 'Normal', 'immunizationStatus' => 'Complete', 'remarks' => 'No significant health issues'],
            ['recordId' => 'MR-2026-04', 'status' => 'Active', 'studentId' => 'BCP-2024-0004', 'studentName' => 'Ana Rodriguez', 'department' => 'GAS', 'yearLevel' => 'Grade 11', 'section' => 'C', 'bloodType' => 'AB-', 'allergies' => 'Latex', 'medicalConditions' => 'None', 'height' => '160', 'weight' => '52', 'vision' => '20/20', 'hearing' => 'Normal', 'immunizationStatus' => 'Pending', 'remarks' => 'Allergy alert for medical equipment'],
        ...
        'staff' => [
            ['name' => 'Dr. Reyes', 'department' => 'Senior High School', 'position' => 'Teacher', 'bloodType' => 'AB+', 'healthNotes' => 'Regular checkup', 'lastCheckup' => '2026-06-15', 'contactNumber' => '09175556677'],
        ],
        'programs' => [
        ...
        'medicalHistory' => [
            ['historyId' => 'HIST-2026-001', 'studentId' => 'BCP-2024-0001', 'studentName' => 'Juan Dela Cruz', 'department' => 'ICT', 'yearLevel' => 'Grade 12', 'section' => 'A', 'bloodType' => 'O+', 'course' => 'ICT', 'diagnosis' => 'Mild dehydration', 'treatment' => 'Oral rehydration and rest', 'doctor' => 'Dr. Reyes', 'visitDate' => date('Y-m-d')],
            ['historyId' => 'HIST-2026-002', 'studentId' => 'BCP-2024-0002', 'studentName' => 'Maria Santos', 'department' => 'HUMSS', 'yearLevel' => 'Grade 11', 'section' => 'B', 'bloodType' => 'A+', 'course' => 'HUMSS', 'diagnosis' => 'Tetanus booster needed', 'treatment' => 'Administered tetanus vaccine', 'doctor' => 'Nurse Admin', 'visitDate' => date('Y-m-d', strtotime('-7 days'))],
        ],
    ];
